...
2022: Cost data available (s436a_1 s436a_2 s436a_3 s436a_4 s436a_5 s436a_6)
2017-18: Cost data available 
2014: Cost data available
2011: No cost data 
2007 and older: Not checked 
*need to check if all the outcome variables are reported in dollar 
*/
...
keep v007 v005 v012 v013 v021 v022 v024 v025 v106 v130 v136 v158 v159 v190 v218 v445 v701 v704 v705 v714 m15_1 m15_2 m15_3 m15_4 m15_5 m15_6 m17_1 m17_2 m17_3 m17_4 m17_5 m17_6 s436a_1  bord_01 tab m14_1
...
recode m15_1 10/11=.
recode m15_1 42/96=.
recode m15_1 (20/28=0 "Public Facility-based deliveries") (30/36=1 "Private Facility-based deliveries") (40/41=2 "NGO"), gen(delivery_place)
...
tabstat cod_usd if delivery_place==2, by (delivery_types)  stat(n mean sd median iqr  p50 p25 p75) format(%9.2f)
...
tabstat v012, stat(n mean sd p50 p25 p75)
...
replace nlc=2 if v218>=3
label variable nlc "number of living childern category"
label define nlclabel 0 "0" 1 "1~2" 2 ">=3" 
label value nlc nlclabel 
*tab nlc, missing
tab nlc, missing

svy: tab nlc, count format(%9.0f)
svy: tab nlc, format(%9.4f)

tabstat cod_usd if nlc==0, by (delivery_types)  stat(n mean sd median iqr  p50 p25 p75) format(%9.2f)
tabstat cod_usd if nlc==1, by (delivery_types)  stat(n mean sd median iqr  p50 p25 p75) format(%9.2f)
tabstat cod_usd if nlc==2, by (delivery_types)  stat(n mean sd median iqr  p50 p25 p75) format(%9.2f)
